...
public final class ApplicationExceptions {
    ...
    public static class MetadataExtractionException extends RuntimeException {
        public MetadataExtractionException(String message, Throwable cause) { super(message, cause); }
    }
    public static class JpaParsingException extends RuntimeException {
        public JpaParsingException(String message) { super(message); }
        public JpaParsingException(String message, Throwable cause) { super(message, cause); }
    }
    public static class FileGenerationException extends RuntimeException {
        public FileGenerationException(String message, Throwable cause) { super(message, cause); }
    }
}